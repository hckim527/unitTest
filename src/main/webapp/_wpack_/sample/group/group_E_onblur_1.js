/*amd /sample/group/group_E_onblur_1.xml 6127 5c98069e6db7dc77c0a2ae94ddf5b31ae2d1404d2ca0e0433c526c53abc0e940 */
...
scwin.comp_init = async function () {
  ...
  scwin.grp_1 = await $p.dynamicCreate("grp_1", "group", {
    style: "background-color:#B0E0E6; width:200px; height:100px; margin-bottom:6px;"
  }, grp_comp);
  scwin.grp_1.bind("onblur", "scwin.grp_1_onblur");
...
scwin.grp_1_onblur = function (e) {
  objReturn = wf_return.getObj("tbx_return");
  objReturn.setValue(objReturn.getValue() + "onblur 이벤트 발생 <br/>");
